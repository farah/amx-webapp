...
const StripeSvg: React.FC = () => {
  return (
    <svg
      className="SVGInline-svg SVGInline--cleaned-svg SVG-svg Logo-svg Icon-color-svg Icon-color--blue500-svg"
      xmlns="http://www.w3.org/2000/svg"
      width="360"
      height="150"
      viewBox="0 0 360 150"
      style={{ height: "32px", width: "77px" }}
    >
      <path
        fillRule="evenodd"
