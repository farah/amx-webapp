...
import { Size } from "@transferwise-ui/common";
...
import "./ReceiverMobileInput.css";

const ALLOWED_PHONE_CHARS = /^$|^[\d-\s]+$/;

const ReceiverMobileInput = props => {
  const {
    onChange,
    searchPlaceholder,
    disabled,
...
ReceiverMobileInput.Size = Size;

ReceiverMobileInput.propTypes = {
  required: Types.bool,
  disabled: Types.bool,
  ...
  size: Types.oneOf([ReceiverMobileInput.Size.SMALL, ReceiverMobileInput.Size.MEDIUM, ReceiverMobileInput.Size.LARGE]),
  placeholder: Types.string
};

ReceiverMobileInput.defaultProps = {
  required: false,
  disabled: false,
  initialValue: null,
  onFocus() {},
  ...
  size: ReceiverMobileInput.Size.MEDIUM,
  placeholder: ""
};

export default ReceiverMobileInput;
